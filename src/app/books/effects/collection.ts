...
export class CollectionEffects {
  ...
  @Effect()
  addBookToCollection$: Observable<Action> = this.actions$.ofType(CollectionActionTypes.AddBook)
  .pipe(
  ...
  @Effect()
  removeBookFromCollection$: Observable<Action> = this.actions$.ofType(CollectionActionTypes.RemoveBook)
  .pipe(
